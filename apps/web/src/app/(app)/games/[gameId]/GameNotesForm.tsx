...
import { saveGameNotesAction } from './actions';
...
export function GameNotesForm({
  ...
  const [state, formAction] = useFormState(saveGameNotesAction, null);
    ...
    <form action={formAction} className="space-y-8">
      ...
      <section>
        ...
        <textarea
          ...
          placeholder="General game summary, key moments, weather conditions..."
